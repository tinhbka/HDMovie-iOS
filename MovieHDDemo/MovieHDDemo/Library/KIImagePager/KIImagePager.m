...
//            if (!IS_DEVICE_IPAD){
//                imageView.contentMode = UIViewContentModeScaleToFill;//UIViewContentModeScaleToFill UIViewContentModeScaleAspectFit
//            }
...
- (void) initializePageControl
{
    ...
    _pageControl.center = CGPointMake(_scrollView.frame.size.width / 2, _scrollView.frame.size.height - 52.0);
